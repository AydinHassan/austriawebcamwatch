...
<template>
  <div class="hidden md:flex space-x-2 lg:space-x-4">
    ...
    <DropdownMenu>
      ...
      <Button @click="loginOpen = true" variant="outline" class="px-3 lg:px-4"> <PersonIcon :class="user ? 'text-green-500' : 'text-red-400'" /> </Button>
  </div>
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent class="min-w-48">
        ...
        <DropdownMenuItem @click="loginOpen = true">
          <PersonIcon class="mr-2 h-4 w-4" :class="user ? 'text-green-500' : 'text-red-400'" />
          {{ user ? 'Profile' : 'Login' }}
        </DropdownMenuItem>
    ...
    <DialogScrollContent class="w-[90vw] sm:max-w-sm">
      ...
      <div class="flex space-x-2 flex-col pt-6">
        <div v-if="user" class="flex flex-col gap-4">
          ...
          <Button variant="destructive" type="button" @click="logout">Logout</Button>
        </div>
        <Button v-else variant="outline" type="button" @click="login('github')">
